<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="upload" v-if="type!='info' && !ro.usersPhoto" label="用户头像" prop="usersPhoto">
          <file-upload
            tip="点击上传头像"
            action="file/upload"
            :limit="3"
            :multiple="true"
            :fileUrls="ruleForm.usersPhoto || ''"
            @change="usersPhotoUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.usersPhoto" label="用户头像" prop="usersPhoto">
            <img :src="ruleForm.usersPhoto?$base.url+ruleForm.usersPhoto:''" width="100" height="100" style="object-fit:cover">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.role = true;
          ...
          if(o=='usersPhoto'){
            this.ruleForm.usersPhoto = obj[o];
	    this.ro.usersPhoto = true;
            continue;
          }
        }
      }
    ...
    usersPhotoUploadChange(fileUrls) {
        this.ruleForm.usersPhoto = fileUrls;
    },
    // 返回
    back() {
      this.parent.showFlag = true;
